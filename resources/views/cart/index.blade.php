                        ...
                        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                            <div class="flex w-2/5">
                                ...
                                <div class="flex flex-col justify-between ml-4 flex-grow">
                                    <a href="{{ route('product.show', ['id' => $item->model->id]) }}"><span class="font-bold text-sm">{{ $item->name }}</span></a>
                            ...
                            <div class="flex justify-center items-center w-1/5">
                                ...
                                <form id="update_item" action="{{ route('cart.update', ['id' => $item->id]) }}"
                                    method="POST">
                                    @csrf
                                    <input name="quantity" class="mx-2 border text-center w-16" type="number"
                                        value="{{ $item->quantity }}">
                                </form>
                                <svg class="fill-current text-gray-600 w-3" viewBox="0 0 448 512">
                                    <path
                            ...
                            <span class="text-center w-1/5 font-semibold text-sm">{{ $item->getPriceSum() }} €</span>
                        </div>
                    @endforeach
                @endif
